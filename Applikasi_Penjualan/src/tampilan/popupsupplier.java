...
public tambahbarang popsup = null;
    /**
    ...
    private void tblsupMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblsupMouseClicked
        ...
        int tableSupplier = tblsup.getSelectedRow();
        popsup.idsup = tblsup.getValueAt(tableSupplier, 0).toString();
        popsup.namasup = tblsup.getValueAt(tableSupplier, 1).toString();
        popsup.tlpsup= tblsup.getValueAt(tableSupplier, 2).toString();
        popsup.emailsup = tblsup.getValueAt(tableSupplier, 3).toString();
        popsup.almtsup= tblsup.getValueAt(tableSupplier, 4).toString();
