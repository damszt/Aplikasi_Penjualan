...
public nota brg = null;
    ...
    private void tblbarangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblbarangMouseClicked
        ...
        brg.kdbrg = tblbarang.getValueAt(tableBarang, 0).toString();
        brg.nmbrg = tblbarang.getValueAt(tableBarang, 1).toString();
        brg.jenisbrg = tblbarang.getValueAt(tableBarang, 2).toString();
        brg.hb = tblbarang.getValueAt(tableBarang, 3).toString();
        brg.hj = tblbarang.getValueAt(tableBarang, 4).toString();
        brg.stok = tblbarang.getValueAt(tableBarang, 5).toString();
        brg.itemTerpilihBrg();
        this.dispose();
